    ...
    <style>
        ...
        * {
        ...
        .nav-right {
            display: flex;
            align-items: center;
            gap: 30px; /* Jarak antara nav-links dan tombol login */
        }
        ...
        .login-btn {
            background-color: var(--color-primary-orange); /* Diubah ke warna primary untuk kontras */
            color: var(--color-light-text);
            padding: 8px 15px;
            border-radius: 5px;
            font-weight: bold;
        ...
        .hero {
            position: relative;
            height: 90vh; 
            background: url('bg_responsi.jpg') no-repeat center center/cover;
            display: flex;
        ...
        .kecak { background-image: url('https://picsum.photos/400/180?blur=5&random=1'); } 
        .barong { background-image: url('https://picsum.photos/400/180?blur=5&random=2'); } 
        .legong { background-image: url('https://picsum.photos/400/180?blur=5&random=3'); }
    ...
    <header>
        <nav id="mainNav">
            ...
            <div class="nav-right">
                ...
                <a href="#login" class="login-btn login-btn-desktop">Log In</a>
    ...
    <main>
        <section class="hero" id="home" role="region" aria-label="Halaman Utama Promosi Tari Bali">
            <div class="hero-content">
                ...
                <a href="#events" class="explore-btn">EXPLORE EVENTS</a>
            </div>
        </section>
